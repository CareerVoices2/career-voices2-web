    ...
    def get_voices(self):
        ...
        try:
            ...
            for file in files:
                ...
                md_file = requests.get(file["download_url"],
                            ...
                            if key == "offer_timing":
                                ...
                                for offer_line in header_lines[line_num+1:]:
                                    ...
                                    if ":" in offer_line:
                                        ...
                                        # offer_timingはgradeとmonthの2つの情報があるので、
                                        # 両方取得したらループを抜ける
                                        if cnt == 2:
                                            # line_numを更新して、次の行から処理するようにする
                                            line_num += cnt
                                            if DEBUG:
                                                print("updated line_num:",
                                                      line_num)
                                            break
                                    else:
                                        break
